WatchApp.prototype.makeApp = function(appBox) {
	...
	var appDoc = document.createElementNS("http://www.w3.org/2000/svg", "svg");
	var defaultViewBox = [-187.5,-235,375,470];
	appDoc.setAttribute("viewBox", defaultViewBox.join(" "));
...
WatchApp.prototype.drawMinuteHand = function(forIcon) {
...
WatchApp.prototype.drawHourHand = function(forIcon) {
...
WatchApp.prototype.resetStyleTag = function() {
	var now = new Date();
