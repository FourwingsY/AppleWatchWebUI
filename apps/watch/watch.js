...
var watch = {
	...
	drawWatch: function(forIcon) {
		var app = document.createElementNS(svgns, "svg");
		...
		mask.id = "masking";
		var maskingCircle = document.createElementNS(svgns, "circle");
		maskingCircle.id = "maskingCircle";
		maskingCircle.setAttribute("cx", 0);
		maskingCircle.setAttribute("cy", 0);
		maskingCircle.setAttribute("r", 0);
		// maskingCircle.setAttribute("r", defaultViewBox[2] / 2);
		maskingCircle.setAttribute("fill", "white");

		if (!forIcon) {
			mask.appendChild(maskingCircle);
			defs.appendChild(mask);
			app.appendChild(defs);
		}
		...
		background.setAttribute("style", "mask:url(#masking);");
	...
	drawSecondHand: function(forIcon) {
		...
		var secondHand = document.createElementNS(svgns, "g");
	...
	drawMinuteHand: function(forIcon) {
		...
		var minuteHand = document.createElementNS(svgns, "g");
	...
	drawHourHand: function(forIcon) {
		...
		var hourHand = document.createElementNS(svgns, "g");
